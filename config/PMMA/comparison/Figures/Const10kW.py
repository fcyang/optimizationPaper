...
fileName = 'PMMAConstNominal10KW_0_cone_Mass.csv'
...
# Save figures
plt.tight_layout()
plt.savefig('PMMA_Const_10kW_Mass_Comparison.png', dpi=300)
plt.show()
plt.close()
