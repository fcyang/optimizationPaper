...
fileName = 'PMMALinearNominal10KW_0_cone_Mass.csv'
...
plt.plot(dfMassNorminal[0], dfMassNorminal[1], '-k', marker='o', markerfacecolor='none', markevery=110, linewidth=1.0)
plt.plot(dfMassHybrid[0], dfMassHybrid[1], '--', marker='^', markerfacecolor='none', markevery=110, color=colors[0], linewidth=1.0)
plt.plot(dfMassWide[0], dfMassWide[1], '-.', marker='v', markerfacecolor='none', markevery=110, color=colors[1], linewidth=1.0)
...
plt.axis([0, 6000, 0.20, 1.05])
# Save figures
plt.tight_layout()
plt.savefig('PMMA_Linear_10kW_Mass_Comparison.png', dpi=300)
plt.show()
plt.close()
