...
fileName = 'PMMAConstNominal75KW_0_cone_Mass.csv'
...
plt.axis([0, 400, 0.0, 1.05])
# Save figures
plt.tight_layout()
plt.savefig('PMMA_Const_75kW_Mass_Comparison.png', dpi=300)
plt.show()
plt.close()
