...
fileName = 'PMMALinearNominal50KW_0_cone_Mass.csv'
...
plt.axis([0, 600, 0.00, 1.05])
# Save figures
plt.tight_layout()
plt.savefig('PMMA_Linear_50kW_Mass_Comparison.png', dpi=300)
plt.show()
plt.close()
