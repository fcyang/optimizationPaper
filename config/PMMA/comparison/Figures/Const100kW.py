...
fileName = 'PMMAConstNominal100KW_0_cone_Mass.csv'
...
plt.axis([0, 250, 0.00, 1.05])
# Save figures
plt.tight_layout()
plt.savefig('PMMA_Const_100kW_Mass_Comparison.png', dpi=300)
plt.show()
plt.close()
