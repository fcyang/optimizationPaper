...
fileName = 'E_GlassOldLinearNominal75KW_0_cone_Mass.csv'
...
plt.axis([0, 400, 0.70, 1.05])
# Save figures
plt.tight_layout()
plt.savefig('E_Glass_Old_Linear_75kW_Mass_Comparison.png', dpi=300)
plt.show()
plt.close()
...
plt.axis([low, high, 0.8, 0.95])
# Save figures
plt.tight_layout()
plt.savefig('E_Glass_Old_Linear_75kW_Mass_Comparison_ZoomIn.png', dpi=300)
plt.show()
plt.close()
