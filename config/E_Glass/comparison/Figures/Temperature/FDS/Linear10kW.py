...
fileName = 'Linear/E_GlassOldLinearNominal10KW_s0_devc.csv'
...
fileName = 'Linear/E_GlassOldLinearWide10KW_s0_devc.csv'
df = pd.read_csv(fileName, skiprows=1)
...
fileName = 'Linear/E_GlassOldLinearHybrid10KW_s0_devc.csv'
df = pd.read_csv(fileName, skiprows=1)
...
plt.axis([0, 3000, 20, 350])
# Save figures
plt.tight_layout()
plt.savefig('E_Glass_Old_Linear_10kW_Temp_Comparison.png', dpi=300)
plt.show()
plt.close()
