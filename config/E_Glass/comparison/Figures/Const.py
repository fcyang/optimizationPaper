...
fileName = 'E_GlassConstNominal35KW_0_cone_Mass.csv'
...
# Save figures
plt.tight_layout()
plt.savefig('E_Glass_Const_35kW_Mass_Comparison.png', dpi=300)
plt.show()
plt.close()
...
# Save figures
plt.tight_layout()
plt.savefig('E_Glass_Const_35kW_Mass_Comparison_ZoomIn.png', dpi=300)
plt.show()
plt.close()
