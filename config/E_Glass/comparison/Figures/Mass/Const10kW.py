...
fileName = 'E_GlassOldConstNominal10KW_0_cone_Mass.csv'
...
plt.plot(dfMassNorminal[0], dfMassNorminal[1], '-k', marker='o', markerfacecolor='none', markevery=90, linewidth=1.0)
plt.plot(dfMassHybrid[0], dfMassHybrid[1], '--', marker='^', markerfacecolor='none', markevery=90, color=colors[0], linewidth=1.0)
plt.plot(dfMassWide[0], dfMassWide[1], '-.', marker='v', markerfacecolor='none', markevery=90, color=colors[1], linewidth=1.0)
...
H = plt.legend(leg, loc='lower left', prop={'size': 16}, numpoints=1,
               frameon=False)
plt.rc('xtick', labelsize=16)
plt.rc('ytick', labelsize=16)
plt.axis([0, 6000, 0.70, 1.05])
# Save figures
plt.tight_layout()
plt.savefig('E_Glass_Old_Const_10kW_Mass_Comparison.png', dpi=300)
plt.show()
plt.close()
...
plt.plot(dfMassHybrid[0][low:high], dfMassHybrid[1][low:high], '--', marker='^', markerfacecolor='none', markevery=30, color=colors[0], markersize=15, markeredgewidth=2, linewidth=2.0)
...
plt.axis([150, 350, 0.8, 0.95])
# Save figures
plt.tight_layout()
plt.savefig('E_Glass_Old_Const_10kW_Mass_Comparison_ZoomIn.png', dpi=300)
plt.show()
plt.close()
