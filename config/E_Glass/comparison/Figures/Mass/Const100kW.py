...
fileName = 'E_GlassOldConstNominal100KW_0_cone_Mass.csv'
...
plt.axis([0, 500, 0.70, 1.05])
# Save figures
plt.tight_layout()
plt.savefig('E_Glass_Old_Const_100kW_Mass_Comparison.png', dpi=300)
plt.show()
plt.close()
...
# Save figures
plt.tight_layout()
plt.savefig('E_Glass_Old_Const_100kW_Mass_Comparison_ZoomIn.png', dpi=300)
plt.show()
plt.close()
