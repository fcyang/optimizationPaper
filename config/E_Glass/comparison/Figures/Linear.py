...
fileName = 'E_GlassLinearNominal35KW_0_cone_Mass.csv'
...
plt.axis([0, 1000, 0.65, 1.05])
# Save figures
plt.tight_layout()
plt.savefig('E_Glass_Linear_35kW_Mass_Comparison.png', dpi=300)
plt.show()
plt.close()
...
# Save figures
plt.tight_layout()
plt.savefig('E_Glass_Linear_35kW_Mass_Comparison_ZoomIn.png', dpi=300)
plt.show()
plt.close()
