...
fileName = 'data/charLinear1ReacIgn'
figureName = 'charLinear1ReacIgn'
massCol = ['# Time [s]',' Mass [Kg]']
tempCol = ['# Time [s]',' Temperature [C]']
dfMass = []
dfFT = []
dfBT = []
fileSeq = ['Nominal', '2MassTGA', '2Mass']
heatFlux = ['75kW', '100kW']
# fileSeq = ['Nominal', 'TGADSC', '3Mass', 'TGA']
# heatFlux = ['10kW', '100kW']
legList = ['Virtual', '2MassTGA', '2Mass']
...
H = plt.legend(loc='lower left', prop={'size': 14}, numpoints=1,
                            frameon=False)
plt.axis([0, axisList[1], 0.7, 1.05])
plt.rc('xtick', labelsize=16)
plt.rc('ytick', labelsize=16)
# save figures
plt.tight_layout()
plt.savefig(figureName + '75kW' + 'NormalizedMass' +'.png', dpi=300)
plt.show()
