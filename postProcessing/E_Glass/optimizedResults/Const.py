...
fileName = 'E_GlassOldConstNominal_0_cone_Mass.csv'
...
plt.axis([0, 1200, 0.70, 1.05])
# Save figures
plt.tight_layout()
plt.savefig('E_Glass_Old_Const_Mass_Comparison.png', dpi=300)
plt.show()
plt.close()
...
plt.axis([600, 800, 0.8, 0.95])
# Save figures
plt.tight_layout()
plt.savefig('E_Glass_Old_Const_Mass_Comparison_ZoomIn.png', dpi=300)
plt.show()
plt.close()
